		...
		<div class="span9">
			<?php if(false == $this->session->userdata('login')){ ?>
		  	<div class="hero-unit">
				...
				<p>Une cérémonie officielle sera organisée le Mercredi 20 Mars 2013 à 18h dans l'amphi de la MDI pour décerner les fameuses statuettes tant convoitées, donc tenez-vous prêt !</p>
